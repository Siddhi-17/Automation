...
public class VtigerLoginExcel {
	...
	public void readSheetdetails() throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				"E:\\AutomationSession\\workspace\\MyFirstProject\\src\\test\\resources\\testData\\TextFile.xlsx");
		// Absolute
		...
		workbook.getSheet("Sheet4");// will open TC excel worksheet
	}
