...
public class orange extends SeleniumUtility {
...
//		action.doubleClick(empId).keyDown(Keys.DELETE).sendKeys("1011").build().perform();
		// sendKeys("111")
		// click on save
...
//		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//input[@placeholder='Type for hints...']"))));
		...
		// driver.findElement(By.cssSelector(".oxd-table-filter-area *:nth-child(2)
		// *:nth-of-type(2)>input")).sendKeys("111");
		// driver.findElement(By.xpath("//input[@placeholder='Type for
		// hints...']")).sendKeys("soham khunte");
	...
	public void editPIM() {
		driver.findElement(By.xpath("//a[text()='Employee List']")).click();
		// driver.findElement(By.cssSelector(".oxd-table-filter-area *:nth-child(2)
		// *:nth-of-type(2)>input")).sendKeys("1011");
		driver.findElement(By.xpath("//input[@placeholder='Type for hints...']")).sendKeys("soham khunte");
		driver.findElement(By.xpath("//button[@type='submit']")).click();
		// click on checkbox
	...
	public void deletePIM() throws InterruptedException {
		...
		driver.findElement(By.cssSelector(".oxd-icon.bi-trash")).click();// .oxd-button--medium.oxd-button--label-danger.orangehrm-button-margin")).click();
		driver.findElement(By.cssSelector(".orangehrm-modal-footer>*:nth-of-type(2)")).click();
